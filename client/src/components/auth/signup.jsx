    ...
    <div className="Contain">
      ...
      {!state.mail ? (
          ...
          {!state.filled ? (
            <div className="options">
              ...
              <div data-for="acc-sign-up-login">
                ...
                <Link to={"/login/auth"}>Entrar</Link>
              </div>
            ...
            <form className="Form" onSubmit={formHandle}>
              <div>
                ...
                <div>
                  {state?.error && (
                    <div className="error">
                      <div>!</div> Esse usuário já existe.
                    </div>
                  )}
                </div>
        ...
        <div className="mail">
          ...
          <div>
            <p>
              Por favor, verifique o endereço de e-mail {formData.email} para
              obter instruções de cadastro.
            </p>
          </div>

          <button onClick={() => formHandle(null)}>Reenvie o email</button>
        </div>
      )}
    </div>
  );
